    ...
    <section className="import-panel" aria-labelledby="import-title">
      ...
      {rareAlert && (
        <div className="import-rare-alert">
          <span>🎰 {ui(rareAlert)}</span>
          <button className="announce-close" title={t('Dismiss')} onClick={() => setRareAlert('')}>
            ✕
          </button>
        </div>
      )}
      ...
      >
        <WindowsImportHelp feedbackUrl="https://github.com/Alkwer/one-more-map.github.io/issues" />
      </ImportHelpDisclosure>
