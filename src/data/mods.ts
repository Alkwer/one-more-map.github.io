...
const adjacentImplicits: VoyageModDef[] = [
  ...
  { id: 'adj-octo-1', text: 'Area contains 8-10 additional packs of Octopi', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 45 }] },
  { id: 'adj-octo-2', text: 'Area contains 11-14 additional packs of Octopi', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 62 }] },
  { id: 'adj-crab-1', text: 'Area contains 8-10 additional packs of Crabs', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 45 }] },
  { id: 'adj-crab-2', text: 'Area contains 11-14 additional packs of Crabs', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 62 }] },
  ...
  { id: 'adj-barrel-1', text: 'Area contains 12-15 additional Clusters of Mysterious Barrels', scope: 'adjacent', effects: [{ stat: 'treasure', percent: 50 }] },
  { id: 'adj-barrel-2', text: 'Area contains 16-20 additional Clusters of Mysterious Barrels', scope: 'adjacent', effects: [{ stat: 'treasure', percent: 70 }] },
