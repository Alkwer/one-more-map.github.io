...
const adjacentImplicits: VoyageModDef[] = [
  ...
  { id: 'adj-octo-1', short: '+8-10 Octopi', text: 'Adjacent Areas contain 8-10 additional packs of Octopi', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 25 }] },
  ...
  { id: 'adj-barrel-1', short: '+12-15 Barrels', text: 'Adjacent Areas contain 12-15 additional Clusters of Barrels', scope: 'adjacent', effects: [{ stat: 'treasure', percent: 15 }] },
  { id: 'adj-barrel-2', short: '+16-20 Barrels', text: 'Adjacent Areas contain 16-20 additional Clusters of Mysterious Barrels', scope: 'adjacent', effects: [{ stat: 'treasure', percent: 22 }] },
