...
const adjacentImplicits: VoyageModDef[] = [
  ...
  { id: 'adj-ess-2', short: '+2-4 Imprisoned', text: 'Adjacent Areas contain 2-4 additional Imprisoned Monsters', scope: 'adjacent', effects: [{ stat: 'essences', percent: 30 }] },
  ...
  { id: 'adj-box-2', short: '+2-4 Strongboxes', text: 'Adjacent Areas contain 2-4 additional Strongboxes', scope: 'adjacent', effects: [{ stat: 'treasure', percent: 35 }] },
  ...
  { id: 'adj-octo-1', short: '+8-10 Octopi', text: 'Area contains 8-10 additional packs of Octopi', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 25 }] },
  { id: 'adj-octo-2', short: '+11-14 Octopi', text: 'Area contains 11-14 additional packs of Octopi', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 35 }] },
  { id: 'adj-crab-1', short: '+8-10 Crabs', text: 'Area contains 8-10 additional packs of Crabs', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 25 }] },
  { id: 'adj-crab-2', short: '+11-14 Crabs', text: 'Area contains 11-14 additional packs of Crabs', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 35 }] },
  ...
  { id: 'adj-wisps-1', short: '2000 Wisps', text: 'Monsters have a chance to be Empowered by 2000 Wildwood Wisps', scope: 'adjacent', effects: [{ stat: 'wisps', percent: 30 }] },
  ...
  { id: 'adj-spirit-1', short: '+1 Spirit Cage', text: 'Adjacent Areas contain an additional cage of Tormented Spirits', scope: 'adjacent', effects: [{ stat: 'spirits', percent: 20 }] },
  { id: 'adj-spirit-2', short: '+2 Spirit Cages', text: 'Adjacent Areas contain 2 additional cages of Tormented Spirits', scope: 'adjacent', effects: [{ stat: 'spirits', percent: 38 }] },
  ...
  { id: 'adj-arcbox-1', short: '+2 Arcanist Boxes', text: "Adjacent Areas contain 2 additional Arcanist's Strongboxes", scope: 'adjacent', effects: [{ stat: 'currency', percent: 40 }] },
  ...
  { id: 'adj-barrel-1', short: '+12-15 Barrels', text: 'Area contains 12-15 additional Clusters of Mysterious Barrels', scope: 'adjacent', effects: [{ stat: 'treasure', percent: 15 }] },
  { id: 'adj-barrel-2', short: '+16-20 Barrels', text: 'Area contains 16-20 additional Clusters of Mysterious Barrels', scope: 'adjacent', effects: [{ stat: 'treasure', percent: 22 }] },
  { id: 'adj-star-1', short: '+4-5 Starfish', text: 'Adjacent Areas contains 4-5 additional Giant Starfish', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 15 }] },
  { id: 'adj-star-2', short: '+6-7 Starfish', text: 'Adjacent Areas contains 6-7 additional Giant Starfish', scope: 'adjacent', effects: [{ stat: 'packsize', percent: 20 }] },
  { id: 'adj-lantern', short: '+4 Gold Lanterns', text: 'Adjacent Areas contain 4 additional Golden Lanterns', scope: 'adjacent', effects: [{ stat: 'treasure', percent: 20 }] },
  { id: 'adj-pantheon', short: 'Pantheon Rares', text: 'Rare Monsters in adjacent Areas will have a Pantheon Modifier', scope: 'adjacent', effects: [{ stat: 'rares', percent: 25 }] },
  ...
  { id: 'adj-uamu-1', short: '10% Unique Amulet', text: 'Amulets dropped in adjacent Areas have 10% chance to instead drop as a Unique Amulet', scope: 'adjacent', effects: [{ stat: 'uniques', percent: 20 }] },
  ...
  { id: 'adj-ubelt-2', short: '20% Unique Belt', text: 'Belts dropped in adjacent Areas have 20% chance to instead drop as a Unique Belt', scope: 'adjacent', effects: [{ stat: 'uniques', percent: 40 }] },
]
...
export const BORDER_MODS: BorderModDef[] = [
  ...
  { id: 'b-minmagic', short: 'At Least Magic', text: 'Monsters in Area are at least Magic', effects: [{ stat: 'magicmonsters', percent: 30 }] },
  ...
  { id: 'b-beasts-1', short: '+8 Sea Beast Packs', text: 'Area contains 8 additional packs of Sea Beasts', effects: [{ stat: 'packsize', percent: 25 }] },
  { id: 'b-beasts-2', short: '+12 Sea Beast Packs', text: 'Area contains 12 additional packs of Sea Beasts', effects: [{ stat: 'packsize', percent: 35 }] },
  { id: 'b-beasts-3', short: '+16 Sea Beast Packs', text: 'Area contains 16 additional packs of Sea Beasts', effects: [{ stat: 'packsize', percent: 45 }] },
  { id: 'b-crabs-1', short: '+8 Crab Packs', text: 'Area contains 8 additional packs of Crabs', effects: [{ stat: 'packsize', percent: 25 }] },
  { id: 'b-crabs-2', short: '+12 Crab Packs', text: 'Area contains 12 additional packs of Crabs', effects: [{ stat: 'packsize', percent: 35 }] },
  { id: 'b-crabs-3', short: '+16 Crab Packs', text: 'Area contains 16 additional packs of Crabs', effects: [{ stat: 'packsize', percent: 45 }] },
  { id: 'b-drowned-1', short: '+8 Drowned Packs', text: 'Area contains 8 additional packs of Drowned', effects: [{ stat: 'packsize', percent: 25 }] },
  { id: 'b-drowned-2', short: '+12 Drowned Packs', text: 'Area contains 12 additional packs of Drowned', effects: [{ stat: 'packsize', percent: 35 }] },
  { id: 'b-drowned-3', short: '+16 Drowned Packs', text: 'Area contains 16 additional packs of Drowned', effects: [{ stat: 'packsize', percent: 45 }] },
  ...
  { id: 'b-octoboss', short: 'Filthscrabble', text: 'Area contains Filthscrabble', effects: [{ stat: 'treasure', percent: 30 }] },
  ...
  { id: 'b-ancient', short: '+1 Ancient Drop', text: 'Rare Monsters in Area drop an additional Ancient Orb', effects: [{ stat: 'currency', percent: 30 }] },
  { id: 'b-divine', short: '+1 Divine Drop', text: 'Rare Monsters in Area drop an additional Divine Orb', effects: [{ stat: 'currency', percent: 120 }] },
  { id: 'b-exalt', short: '+1 Exalt Drop', text: 'Rare Monsters in Area drop an additional Exalted Orb', effects: [{ stat: 'currency', percent: 45 }] },
  { id: 'b-annul', short: '+1 Annul Drop', text: 'Rare Monsters in Area drop an additional Annulment Orb', effects: [{ stat: 'currency', percent: 25 }] },
  { id: 'b-chaos', short: '+1 Chaos Drop', text: 'Rare Monsters in Area drop an additional Chaos Orb', effects: [{ stat: 'currency', percent: 15 }] },
  { id: 'b-vaal', short: '+1 Vaal Drop', text: 'Rare Monsters in Area drop an additional Vaal Orb', effects: [{ stat: 'currency', percent: 10 }] },
  { id: 'b-gcp', short: '+1 GCP Drop', text: "Rare Monsters in Area drop an additional Gemcutter's Prism", effects: [{ stat: 'currency', percent: 12 }] },
  { id: 'b-chrome', short: '+1 Chromatic Drop', text: 'Rare Monsters in Area drop an additional Chromatic Orb', effects: [{ stat: 'currency', percent: 3 }] },
  { id: 'b-regret', short: '+1 Regret Drop', text: 'Rare Monsters in Area drop an additional Orb of Regret', effects: [{ stat: 'currency', percent: 8 }] },
  { id: 'b-blessed', short: '+1 Blessed Drop', text: 'Rare Monsters in Area drop an additional Blessed Orb', effects: [{ stat: 'currency', percent: 5 }] },
  { id: 'b-regal', short: '+1 Regal Drop', text: 'Rare Monsters in Area drop an additional Regal Orb', effects: [{ stat: 'currency', percent: 8 }] },
  { id: 'b-support', short: '20% Support Gem', text: 'Rare Monsters in Area have 20% chance to drop a Support Gem', effects: [{ stat: 'currency', percent: 15 }] },
  { id: 'b-locker', short: "Pirate's Locker", text: "Area contains an additional Pirate's Locker", effects: [{ stat: 'treasure', percent: 30 }] },
  { id: 'b-pirates', short: 'Brinerot Party', text: 'Area contains a Brinerot Raiding Party', effects: [{ stat: 'packsize', percent: 20 }] },
  ...
  { id: 'b-decks', short: 'Stacked Decks', text: 'Basic Currency items dropped by Monsters in Area will instead drop as Stacked Decks', effects: [{ stat: 'divcards', percent: 40 }] },
  { id: 'b-scarabdrop', short: '+1 Scarab Drop', text: 'Rare Monsters in Area drop an additional Scarab', effects: [{ stat: 'scarabs', percent: 25 }] },
