...
export const BORDER_MODS: BorderModDef[] = [
  ...
  { id: 'b-ancient', short: '+1 Ancient Drop', text: 'Rare Monsters in adjacent Areas drop 1 additional Ancient Orbs', effects: [{ stat: 'currency', percent: 30 }] },
  { id: 'b-divine', short: '+1 Divine Drop', text: 'Rare Monsters adjacent in Areas drop 1 additional Divine Orbs', effects: [{ stat: 'currency', percent: 120 }] },
  ...
  { id: 'b-blessed', short: '+1 Blessed Drop', text: 'Rare Monsters in adjacent Areas drop 1 additional Blessed Orbs', effects: [{ stat: 'currency', percent: 5 }] },
  { id: 'b-regal', short: '+1 Regal Drop', text: 'Rare Monsters in adjacent Areas drop 1 additional Regal Orbs', effects: [{ stat: 'currency', percent: 8 }] },
